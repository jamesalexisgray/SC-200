...
| Source basis | Compiled from the candidate's Microsoft Learn course notes and the measured skills list provided in the chat. Verify the official skills outline again immediately before booking the exam, as Microsoft exam objectives can change. |
